...
<body>
	...
	<div class="container">
		...
		<div class="span8 radius-div">
			...
			<div>
				<form class="form-horizontal" action="/back/flowsolution/add.do" method="post">
					<div class="control-group">
						<label class="control-label">套餐价格</label>
						<div class="controls">
							<input type="text" id="solutionprice" name="wechattypename" placeholder="套餐价格"></input>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">套餐折扣</label>
						<div class="controls">
							<input type="text" id="solutiondiscount" placeholder="套餐折扣"></input>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">文本信息条数</label>
						<div class="controls">
							<input type="text" id="textMsgNum" placeholder="文本信息条数"></input>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">图文信息条数</label>
						<div class="controls">
							<input type="text" id="imgtxtMsgNum" placeholder="图文信息条数"></input>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">语音信息条数</label>
						<div class="controls">
							<input type="text" id="vadioMsgNum" placeholder="语音信息条数"></input>
						</div>
					</div>
					<div class="control-group">
	...
	<script type="text/javascript">
		$(function() {
			$("#btn-sure").click(function() {
				var url = "/back/flowsolution/add.do";
				...
				var data = {"textMsgNum":textMsgNum,"imgtxtMsgNum":imgtxtMsgNum,"vadioMsgNum":vadioMsgNum,"solutionPrice":solutionprice,"solutionDiscount":solutiondiscount};
				$.ajax({
					type:"post",
					data:data,
					url:url,
